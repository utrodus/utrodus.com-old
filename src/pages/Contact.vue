<template>
  <Layout>
    <div class="about">
      ...
      <p class="term">
        If you have a project you would like to discuss or want to hire me for, please feel free to email me.
      </p>
      <hr />
      ...
      <div class="about-content">
        <div class="paragraf">
          <p>
            Email:
            <a href="mailto:contact.utrodus@gmail.com" class="email">
